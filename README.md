...
To run the addressmapper execute following commands. This may take about 20 minutes for whole Greater Melbourne. The `-Xmx4g` flag is only requied if `-h` option is specified.

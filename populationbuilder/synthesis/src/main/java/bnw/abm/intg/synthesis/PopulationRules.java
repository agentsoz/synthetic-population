...
public class PopulationRules {
    ...
    /**
     * Returns a suitable child for the given parent. If the child is found the its index is returned. Rule applied here
     * is: a child must come from an age category with at least a 15 year age gap (younger) to the parent's.
     *
    ...
    /**
     * Finds a suitable household that the given child can be added. Rule applied here is: a child must come from an age
     * category with at least a 15 year age gap (younger) to the parent's.
     *

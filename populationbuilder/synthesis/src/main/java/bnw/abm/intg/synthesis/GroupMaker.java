...
//        List<Family> primaryOtherFamiliesBasic = null; //familyFactory.makeOtherFamilyBasicUnits(fCount, relatives);
//        Log.debug("Remaining Relatives: " + relatives.size());
//
//        try {
...
//
//
//        return familyFactory.formOneParentBasicUnits(newLoneParents, children);
//    }
//
//    /**

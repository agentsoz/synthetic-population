...
public class CoordinateConversion {
	...
	public Map<String,Double> latLon2UTM(double latitude, double longitude) {
	...
	private class LatLon2UTM {
		public Map<String,Double> convertLatLonToUTM(double latitude, double longitude) {
			...
			HashMap<String,Double> utm = new HashMap<String,Double>();
			utm.put("easting", _easting);
			utm.put("northing", _northing);
			return utm;

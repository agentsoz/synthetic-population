...
public class Buildings {
     ...
     * @return SimpleFeatureCollection object of all the matching buildings in given file
     * @throws IOException
     */
    static SimpleFeatureCollection getBuildings(Path inputFile, String filterByProperty, String[] filterByValues,
	    CoordinateReferenceSystem targetCRS) throws IOException {
	SimpleFeatureCollection buildingsCollection = null;
	ShapefileGeoFeatureReader buildingPolygonsReader = new ShapefilePolygonReader();
	try {
